...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['clinic-owner', 'clinic-manager', 'doctor', 'receptionist', 'accountant'];
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Accounts', path: '/accounts', entity: 'account', service: AccessServiceEnum.PROJECT, icon: FiDollarSign },
    {
      name: 'Appointments',
      path: '/appointments',
      entity: 'appointment',
